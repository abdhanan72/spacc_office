   ...
   void _postReceipt() async {
    ...
    if (result["response_code"] == 27) {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Receipt successfully posted')));
    } else {
      // ignore: use_build_context_synchronously
          ...
          child: SafeArea(
            ...
            child: Column(
              children: [
                ...
                Text(
                  "Current Balance:Rs$firstbalance.00",
                                                  ...
                                                  children: [
                                                    GestureDetector(
                                                      onTap: () {
                                                        ...
                                                        Navigator.pop(context);
                                                        setState(() {
                                                          secondbalance=datum.currentBalance;
                                                          _focusNode.unfocus();
                ...
                Text(
                  "Current Balance:Rs$secondbalance.00",
                  style: const TextStyle(fontWeight: FontWeight.bold),
                ),
                Padding(
                  padding: EdgeInsets.symmetric(
